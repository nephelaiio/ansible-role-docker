...
ansible-playbook --become --connection=local -i inventory playbook.yml -t install -e docker_pip_helpers='[]'
ansible-playbook --connection=local -i inventory playbook.yml -t configure -e docker_pip_helpers='[]' ${POSITIONAL[@]}
popd
